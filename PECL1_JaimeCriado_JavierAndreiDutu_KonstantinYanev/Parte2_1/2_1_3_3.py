...
DOMINIO = "domain.pddl"
PROBLEMA = "problem_d1_r1_l6_p6_c6_g6.pddl"
LIMITE_TIEMPO = 60

CARPETA_RESULTADOS = "resultados_2_1_3_3"
os.makedirs(CARPETA_RESULTADOS, exist_ok=True)

CSV_RESULTADOS = os.path.join(CARPETA_RESULTADOS, "resultados_2_1_3_3.csv")
...
def main():
    ...
    print("PARTE 2 - REPETICION 1.3.3")
    print("=" * 60)
